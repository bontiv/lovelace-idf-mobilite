...
get _messages() {
  ...
  get _exclude_lines_ref() {
    return Array.isArray(this._config.exclude_lines_ref)
      ? this._config.exclude_lines_ref
      : [];
  }
  ...
  get _exclude_second_lines_ref() {
    return Array.isArray(this._config.exclude_second_lines_ref)
      ? this._config.exclude_second_lines_ref
      : [];
  }
  ...
  _renderTabs() {
    return html`
      <div class="tab-group">
        <div
          class="tab ${this.currentPage === "first" ? "active-tab" : ""}"
        ...
        <div
          class="tab ${this.currentPage === "second" ? "active-tab" : ""}"
        ...
        <div
          class="tab ${this.currentPage === "message" ? "active-tab" : ""}"
  ...
  _renderFirstPage() {
    return html`
        ...
        <ha-selector
          ...
          @value-changed=${(ev) => {
            ev.stopPropagation();
            this._config = { ...this._config, exclude_lines_ref: ev.detail.value };
  ...
  _renderSecondPage() {
    return html`
        ...
        <ha-selector
          ...
          @value-changed=${(ev) => {
            ev.stopPropagation();
            this._config = { ...this._config, exclude_second_lines_ref: ev.detail.value };
            fireEvent(this, "config-changed", { config: this._config });
          }}
        ></ha-selector>
